...
class _ProfilePageState extends State<ProfilePage> {
 ...
 String _getStorageBaseUrl() {
  ...
  String baseUrl = Env.apiBaseUrl;
   ...
   return baseUrl.endsWith('/api') ? baseUrl.replaceFirst('/api', '') : baseUrl;
 }
 ...
 Future<void> _updateProfile() async {
  ...
  try {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Profil berhasil diperbarui!'), backgroundColor: primaryColor),
      );
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal update profil: ${e.toString()}"), backgroundColor: Colors.red),
      );
    }
  }
 }
         ...
         children: [
          Container(
           ...
           decoration: BoxDecoration(
            ...
            // Logika ini benar untuk menampilkan NetworkImage
